<template>
  <header class="fixed top-0 z-50 w-full">
    <nav class="flex justify-between">
      <div class="text-shadow cursor-pointer rounded-sm bg-secondary px-3 py-1 text-xl font-semibold lowercase tracking-wide text-primary outline-0 md:text-2xl">
        <NuxtLink to="/">
